...
def main():
    ...
    with sync_playwright() as p:
        ...
        for job in jobs:
            ...
            from .generator import generate_cover_letter, save_cover_letter
            
            print(" -> Generating Cover Letter...")
            letter_content = generate_cover_letter(job, resume_type, PERSONAL_INFO)
            cl_path = save_cover_letter(letter_content, job["Job_ID"], "ub_job_bot/generated_docs")
            ...
            success = apply_to_job(page, job, resume_path, cl_path, PERSONAL_INFO)
